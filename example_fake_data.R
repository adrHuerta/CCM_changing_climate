...
ggplot2::geom_line(data = data_df, ggplot2::aes(x = years, y = values), colour = "gray50", alpha = .7) + 
  ...
  ggplot2::ylab("Air temperature (°C)") + ggplot2::xlab("") + ggplot2::ggtitle("Changing Current Climate Mean") -> p1

ggplot2::ggplot() +
  ggplot2::geom_point(data = data_df, ggplot2::aes(x = years, y = values), size = 2, colour = "gray70") +
  ggplot2::geom_line(data = data_df, ggplot2::aes(x = years, y = values), colour = "gray50", alpha = .7) + 
  ggplot2::geom_hline(yintercept =  unique(data_df$CCM), colour = "#009E73", linewidth = 1.5)   + 
  ggplot2::ylab("Air temperature (°C)") + ggplot2::xlab("") + ggplot2::ggtitle("No Changing Current Climate Mean") -> p2
...
ggplot2::ggplot() +
  ...
  ggplot2::scale_y_continuous(limits = c(-4.15, 4.15)) + ggplot2::ggtitle("Deviation with No Changing Current Climate Mean") -> p3
...
ggplot2::ggplot() +
  ...
  ggplot2::scale_fill_manual(values = c("#D55E00", "#56B4E9")) +
  ggplot2::theme(legend.position = "none") + ggplot2::xlab("") + ggplot2::ylab("") +
  ggplot2::scale_y_continuous(limits = c(-4.15, 4.15))  + ggplot2::ggtitle("Deviation with Changing Current Climate Mean") -> p4
